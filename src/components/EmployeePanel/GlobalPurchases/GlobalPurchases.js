...
const GlobalPurchases = withRouter((props) => {
    const [columns] = useState([
        ...
        { name: 'purchased_by_employee_id', title: 'Purchased By Employee ID' },
        { name: "branch_id", title:"Employee Branch ID"},
    ...
    useEffect(() => {
        async function getGlobalSales() {
            const response = await fetch(
                "/autoshop/api/employees/purchases",
                {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json"
